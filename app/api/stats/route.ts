...
export async function GET(request: NextRequest) {
  try {
    ...
    const [counts, todayTotal, todayCompleted, pendingOld] = await Promise.all([
    ...
    const result = {
      total: 0, pending: 0, assigned: 0, scheduled: 0,
      pickedUp: 0, cancelled: 0, todayTotal, todayCompleted, pendingOld,
    };
