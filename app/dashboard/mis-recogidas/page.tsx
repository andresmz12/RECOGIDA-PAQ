        ...
        <div className="flex items-start justify-between mb-5">
          ...
          {!isDone && (
            <a
              ...
              className="flex items-center gap-2 bg-slate-50 hover:bg-emerald-50 border border-slate-200 hover:border-emerald-300 text-slate-700 hover:text-emerald-700 px-4 py-2 rounded-xl text-sm font-semibold transition-all"
            >
